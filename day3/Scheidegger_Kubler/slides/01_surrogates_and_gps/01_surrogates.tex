...
\vspace{0.4em}
\textbf{Appendix --- the Gaussian-process toolbox} (reference material for the afternoon):
\begin{itemize}\itemsep2pt
...
\end{itemize}
\[
  \mathcal{L}^{\mathrm{dist}}=\mathcal{L}
...
\begin{itemize}\setlength{\itemsep}{1pt}\small
  ...
  \item $w_{\mathrm{obj}}, w_{\mathrm{var}} \geq 0$: weights (independent of AR(1) $\varrho$ and discount $\beta$).
\end{itemize}
\end{block}
