...
\vspace{0.4em}
This session works out the \emphc{estimate} operator in full: simulated method of moments on a Brock--Mirman surrogate --- first a sharply identified scalar ($\varrho$), then a partially identified pair ($\beta, \varrho$).
