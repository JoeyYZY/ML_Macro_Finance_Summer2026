...
\column{0.48\textwidth}
\textbf{Tomorrow (Day 3).}
\begin{itemize}
    \item Surrogate models \& Gaussian processes (incl.\ Bayesian active learning).
    \item Structural estimation with simulated method of moments.
    \item Deep uncertainty quantification \& optimal policy.
\end{itemize}
\end{columns}
\end{frame}
