...
\vspace{0.4em}
\textbf{Coming up tomorrow (Day 3):} surrogate models \& Gaussian processes (incl.\ Bayesian active learning), structural estimation with simulated method of moments, and deep uncertainty quantification \& optimal policy.  \emph{Beyond this course:} heterogeneous agents on a histogram (Young's method), continuum-of-agents DEQN, Krusell--Smith with deep learning, and the sequence-space reformulation.
\end{frame}
