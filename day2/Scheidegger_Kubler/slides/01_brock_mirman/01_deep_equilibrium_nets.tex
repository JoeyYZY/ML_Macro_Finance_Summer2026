...
\begin{itemize}
    \item Four notebooks: BM (01\_01), BM+shocks (01\_02), exercises blank/solved (01\_03/01\_04)
...
\FOR{episode $e = 1, \ldots, E$}
    \STATE \textbf{Simulate path:} $\x_0 \to \x_1 \to \cdots \to \x_{T_{\mathrm{sim}}}$ using $\mathcal{N}_\theta$ and transition law
