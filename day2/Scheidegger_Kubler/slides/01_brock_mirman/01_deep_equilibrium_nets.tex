...
% --- Slide 2: Roadmap ---
\begin{frame}[shrink=5]{Roadmap of This Lecture}
\small
\begin{columns}[T]
...
\begin{frame}{Huge Potential, but Not Yet Turnkey}
\vspace{0.2em}
...
\end{itemize}
\vfill
{\tiny\color{stone} Equilibrium World Models: Schaab et al.\ (2026); world-model /
